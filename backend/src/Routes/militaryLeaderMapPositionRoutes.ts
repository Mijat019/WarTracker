...
router.get(
    "/mapName=:mapName",
    militaryLeaderMapPositionController.getAllForMapByName
);
router.post(
    "/filter/:mapId",
    militaryLeaderMapPositionController.getAllForMapAndFilter
);
router.get(
    "/check/:militaryLeaderId/mapNot/:mapId",
    militaryLeaderMapPositionController.checkPlacement
);
