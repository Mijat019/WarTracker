<template>
    <div>
        ...
        >
            <v-card>
                <v-card-title>
                    <span class="headline" v-if="mode === 'add'">Add a military leade</span>
                                ...
                                <v-row>
                                    ...
                                    <v-col cols="6" md="6" sm="6">
                                        <v-text-field :rules="[rules.required]"
                                                      label="Dynasty Name"
                                                      required
                                                      v-model="dynastyName"></v-text-field>
                                    </v-col>
                                    <v-col cols="6" md="6" sm="6">
                                        <v-text-field :rules="[rules.required]"
                                                      label="Military Rank"
                                                      required
                                                      v-model="militaryRank"></v-text-field>
                                    </v-col>
                                    <v-col cols="6" md="6" sm="6">
                                        <v-text-field :rules="[rules.required]"
                                                      label="School"
                                    ...
                                    <v-col cols="6" md="6" sm="6">
                                        <v-text-field :rules="[rules.required]"
                                                      label="Date Of Birth"
                                                      required
                                                      v-model="dateOfBirth"></v-text-field>
                                    </v-col>
                                    <v-col cols="6" md="6" sm="6">
                                        <v-text-field
                                                label="Date Of Death"
                                                v-model="dateOfDeath"></v-text-field>
                                    </v-col>
                                    ...
                                    <v-img aspect-ratio="1.7" contain v-bind:src="image"></v-img>
                ...
                <v-card-actions>
                    ...
                    <v-btn @click="submit(addMilitaryLeader)" color="blue darken-1" text v-if="mode === `add`">Add
                    </v-btn>
                    <v-btn @click="submit(updateMilitaryLeader)" color="blue darken-1" text v-else>Update</v-btn>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...mapActions("militaryLeader", ["updateMilitaryLeader"]),
            ...mapActions("militaryLeader", ["addMilitaryLeader"]),
            closeAddDialog() {
